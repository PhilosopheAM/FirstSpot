...
/// 每月可攒金额范围
enum SavingsRange {
  lessThan200('<200', '很多人也是从每月 200 开始的，关键是坚持。'),
  between200And500('200-500', '聚沙成塔，这是一个很好的起点。'),
  between500And1000('500-1000', '非常棒的储蓄习惯，你的资产会稳步增长。'),
  moreThan1000('>1000', '充足的现金流能让你在投资时更从容。');
