...
- 录屏演示：首次无学习进度时 `GuidanceUserProgress.load()` 自动解锁 CH01–CH05 卡牌与 3 枚徽章（见 `portfolio-demo-recording.md` 金库一节）。
...
- 2026-05-21: 金库录屏演示：首次空学习进度自动展示 5 张卡牌（CH01–CH05）与 3 枚徽章。
